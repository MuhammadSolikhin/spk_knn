<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if(auth()->user()->role == 'admin')
            ...
            <li class="menu-item {{ request()->routeIs('admin.datatraining.*') ? 'active' : '' }}">
                <a href="{{ route('admin.datatraining.index') }}" class="menu-link">
        ...
        @if(auth()->user()->role == 'siswa')
            ...
            <li class="menu-item {{ request()->routeIs('siswa.konsultasi.create') ? 'active' : '' }}">
                <a href="{{ route('siswa.konsultasi.create') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-calculator"></i>
                    <div data-i18n="Tes Minat">Tes Minat Baru</div>
                </a>
            </li>

            <li class="menu-item {{ request()->routeIs('siswa.konsultasi.index') ? 'active' : '' }}">
                <a href="{{ route('siswa.konsultasi.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-history"></i>
                    <div data-i18n="Riwayat">Riwayat Hasil</div>
                </a>
            </li>
        @endif
